...
from contractManager.api.permissions import IsManagementUser, IsSalesUser, IsSupportUser
from contractManager.models import Role, CustomUser, Client, Contract, Event
from contractManager.api.serializers import RegisterSerializer, TokenObtainPairSerializer, RoleSerializer, CustomUserSerializer, ClientSerializer, ContractSerializer, EventSerializer
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        print(f"Connected User: {self.request.user.role}")
        ...
        if self.action in method_classes:
            print(f"Connected User Role before permission check: {self.request.user.role}")
